              ...
              (newsItem, i) => html`
                <li class=${'news item ' + (newsItem.hostIsBlocked ? 'blocked': '')}>
                  ...
                  <div>
                    ...
                    <span class="host">
                      <a href="javascript:void(0)" onclick=${() => this.block(newsItem.host)}>${newsItem.host}</a>
                      <a href="javascript:void(0)" style=${newsItem.hostIsBlocked ? '': 'display:none'} onclick=${() => this.unblock(newsItem.host)}>unblock</a>
                    </span>
                    <span class="source">${newsItem.label} ${newsItem.label == 'hn' ? '🄷🄽' : '🅻'} <!-- https://fsymbols.com/generators/smallcaps/ --></span>
                    <!-- https://maketext.io/ -->
                    <!--
