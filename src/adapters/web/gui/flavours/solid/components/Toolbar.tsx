          ...
          <ul class="list-group list-group-horizontal">
            <li class="list-group-item">
              <div style="float:right; display: inline-block;">
                ...
                <span class="label">{format(new Date(props.lastUpdated), 'HH:mm')}</span>
              </div>
            </li>
            <li class="list-group-item">
              <div style="float:right; display: inline-block;">
                ...
                </svg><span class="label">{props.deletedCount}</span>
              </div>
            </li>
            <li class="list-group-item">
              <div style="float:right; display: inline-block;">
                <a href="javascript:void(0)" onclick={props.onTogglebookmarks}>
                ...
                </svg></a><span class="label">{props.bookmarkCount}</span>
              </div>
            </li>
          </ul>
        </div>
